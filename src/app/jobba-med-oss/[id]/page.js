...
//   return (
//     <div className="min-h-screen bg-white flex md:my-20 my-8 flex-col justify-center py-12 md:px-4 px-0 lg:px-8">
//       {/* Section 1: Fetch Job Data */}
//       <div className="bg-[#f3f3f3] flex flex-col justify-center rounded-lg p-8 shadow-lg md:w-4/6 mx-auto mb-8">
//         <h1 className="md:text-4xl text-xl font-bold text-[#4a536e] mb-4">Job Details</h1>
//         <div className="flex justify-center">
//           <Image
//             className="md:my-12 my-8 md:w-2/12 w-1/5"
...
//           />
//         </div>
//         <h1 className="md:text-4xl font-bold mb-4">{job.job_title}</h1>
...
//       <div className="bg-white rounded-lg shadow-lg md:p-8 p-2 w-full max-w-4xl">
...
//         {/* Error Message */}
//         {showError && (
//           <div className="bg-red-500 text-white w-full md:p-4 p-2 mb-4 rounded animate-fadeIn">
//             {errorMessage}
//           </div>
//         )}

//         <form onSubmit={handleSubmit} className="md:px-12 pt-6 pb-8 mb-4">
//           <div className="mb-4">
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col justify-center py-12 md:py-20 md:px-4 px-2">
      ...
      <div className="bg-[#f3f3f3] flex flex-col justify-center rounded-lg p-8 shadow-lg 2xl:w-[60rem] max-w-4xl mx-auto mb-8">
        <h1 className="md:text-4xl text-2xl font-bold text-[#4a536e] mb-4 text-center">Job Details</h1>
        <div className="flex justify-center">
          <Image
        ...
        <h1 className="md:text-4xl text-2xl font-bold mb-4 text-center">{job.job_title}</h1>
