    ...
    return (
        ...
        >
            <div className="relative bg-gradient-to-br from-[#f8f9fa] to-[#e9ecef] dark:from-gray-800 dark:to-gray-900 p-6 sm:p-8 md:p-10 lg:p-12 rounded-2xl md:rounded-3xl shadow-lg md:shadow-2xl max-w-4xl w-full text-center backdrop-blur-sm overflow-hidden">
                ...
                <motion.div
                    className="grid grid-cols-1 sm:grid-cols-1 gap-4 md:gap-6"
                    variants={itemVariants}
                >
                    <a
                        href="/files/senior_mech_technician.pdf"
                        className="inline-flex items-center px-0 py-2 md:px-8 md:py-3 lg:px-10 lg:py-4 text-sm md:text-base lg:text-lg bg-[#4a536e] hover:bg-[#3a435e] text-white rounded-lg md:rounded-xl transition-all duration-500 hover:-translate-y-0.5 hover:shadow-lg md:hover:shadow-xl group"
                        target="_blank"
                        rel="noopener noreferrer"
                    >
                        <span className="mr-2">Mechanics / automation senior technician</span>
                        <FiArrowRight className="transform transition-transform duration-300 group-hover:translate-x-1" />
                    </a>

                    <a
                        href="/files/junior_mech_technician.pdf"
                        ...
                        rel="noopener noreferrer"
                    >
                        <span className="mr-2">Mechanics / automation - junior technician</span>
                        <FiArrowRight className="transform transition-transform duration-300 group-hover:translate-x-1" />
                    </a>

                    <a
                        href="/files/senior_elect_technician.pdf"
                        className="inline-flex items-center px-6 py-2 md:px-8 md:py-3 lg:px-10 lg:py-4 text-sm md:text-base lg:text-lg bg-[#4a536e] hover:bg-[#3a435e] text-white rounded-lg md:rounded-xl transition-all duration-500 hover:-translate-y-0.5 hover:shadow-lg md:hover:shadow-xl group"
                        target="_blank"
                        rel="noopener noreferrer"
                    >
                        <span className="mr-2">Electronics / automation senior technician</span>
                        <FiArrowRight className="transform transition-transform duration-300 group-hover:translate-x-1" />
                    </a>

                    <a
                        href="/files/junior_elect_technician.pdf"
                        className="inline-flex items-center px-6 py-2 md:px-8 md:py-3 lg:px-10 lg:py-4 text-sm md:text-base lg:text-lg bg-[#4a536e] hover:bg-[#3a435e] text-white rounded-lg md:rounded-xl transition-all duration-500 hover:-translate-y-0.5 hover:shadow-lg md:hover:shadow-xl group"
                        target="_blank"
                        rel="noopener noreferrer"
                    >
