                  ...
                  <Link href="/installationer" className="group block">
                    <div className="flex justify-between items-center bg-[#4a536e] hover:bg-[#3a435e] transition-colors duration-300 p-4 md:p-6 rounded-lg">
                      <div className="flex flex-col sm:flex-row items-center flex-1 min-w-0">
                        <div className="relative w-12 h-12 md:w-14 md:h-14 shrink-0 mb-2 sm:mb-0">
                          <Image
                        ...
                        <p className="text-base md:text-lg font-bold sm:ml-4 md:ml-6 lg:ml-8 truncate text-center sm:text-left">
                          Installation
                        </p>
                      </div>
                      <FaArrowRightLong className="text-xl md:text-2xl shrink-0 transform group-hover:translate-x-1 transition-transform" />
                    </div>
                  </Link>
