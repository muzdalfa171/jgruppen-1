      ...
      <div className="flex md:flex-row flex-col gap-2 justify-around md:px-8">
        ...
        <div className="w-full  flex flex-col md:items-center items-start justify-start p-8">
          ...
          <div className="flex mt-10 space-x-1">
            ...
            >
              <SlSocialLinkedin className="text-blue-700 h-3 w-3 md:h-6 md:w-6 hover:text-blue-900" />
            </Link>
            <Link
              ...
              className="border border-[#636466] rounded-lg p-1"
            >
              <SlSocialTwitter className="text-blue-500 h-4 w-4 md:h-6 md:w-6 hover:text-blue-700" />
            </Link>
            ...
            <Link
              ...
              className="border border-[#636466] rounded-lg p-1"
            >
              <TiSocialFacebook className="text-blue-800 h-4 w-4 md:h-6 md:w-6 hover:text-blue-900" />
            </Link>
            <Link
              ...
              className="border border-[#636466] rounded-lg p-1"
            >
              <TbBrandTelegram className="text-blue-500 h-4 w-4 md:h-6 md:w-6 hover:text-blue-700" />
            </Link>
            <Link
              ...
              className="border border-[#636466] rounded-lg p-1"
            >
              <FaWhatsapp className="text-green-500  h-4 w-4 md:h-6 md:w-6 hover:text-green-700" />
            </Link>
          </div>
        </div>
          {/* Company Details */}
