...
const Underhall = () => {
  return (
    <>
      <section className="mx-auto pt-30 px-4 md:px-20 ">
        {/* Grid Layout for Two Columns */}
        <div className="grid grid-cols-1 p-6 md:p-12 md:grid-cols-2 gap-8">
          {/* Left Column */}
          <div className="border-8 absolute top-[6rem] overflow-hidden left-[1.5rem] md:left-[3.5rem] border-[#4a536e] w-[20rem] h-60 md:w-[25rem] pl-4"></div>
      ...
      <div className="flex md:flex-col-2   gap-5 py-8">
        <div className="ml-16">
          <Image
