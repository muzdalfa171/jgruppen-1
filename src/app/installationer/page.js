      ...
      <section className="w-full bg-[#f0f1f5] py-12 px-6">
        <div className="container mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            {/* Text Content */}
            <div>
              <h2 className="text-2xl font-bold text-[#4a536e] mb-4">
                Expertis inom installation av materialhanteringssystem
              </h2>
              <p className="text-base font-semibold w-full md:w-3/4 text-gray-600 mb-4">
              ...
              <ul className="text-base text-gray-600 list-none space-y-2">
