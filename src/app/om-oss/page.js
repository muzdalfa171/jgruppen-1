          ...
          <div className="grid grid-row xl:grid-cols-2 gap-8 items-center">
            ...
            <div>
              ...
              <p className="text-md  w-full md:w-11/12 text-gray-700 mb-4">
                Utvecklingen gjorde att Christopher Jarl inledde en
                omorganisation för att skapa en ny struktur som var bättre
                anpassad för framtida krav på en dynamisk marknad. Detta ledde
                till bildandet av JGruppen. Sedan dess har företaget fortsatt
                att växa och bredda sitt utbud av produkter och tjänster.
                Närvaron har förstärkts på nya och befintliga exportmarknader.
              </p>
              <h2 className="text-3xl font-bold text-[#4a536e] mb-4">
                Stolthet
              </h2>
              <p className="text-md w-full md:w-11/12 text-gray-700 mb-4">
                JGruppen har sitt huvudkontor i Motala och antalet anställda är
                drygt 70 personer. En filial har öppnats i Oslo, Norge, och även
                om positionen på den svenska hemmamarknaden är fortsatt stark så
                baseras idag drygt 70% av omsättningen på uppdrag inom
                exportmarknaderna, i Finland, Danmark, Norge, Storbritannien,
                Spanien och Tyskland. Företaget är särskilt stolt över det
                faktum att alla medarbetare har den utbildning och behörighet
                som krävs för att uppfylla kundernas höga krav.{" "}
              </p>
            </div>
